...
|---|----------|------|------------------|------------|--------|---------|----------------|---------|
| 1 | {{var}} | exposure | @bibkey | verbatim from guideline | value + units | `col_a, col_b` | `col_a>=X & col_b==Y` | no |
| 2 | {{var}} | outcome | @bibkey | ... | ... | ... | ... | no |
| 3 | {{var}} | covariate | @bibkey | ... | ... | ... | ... | yes |
| 4 | {{var}} | eligibility | @bibkey | ... | ... | ... | ... | no |
